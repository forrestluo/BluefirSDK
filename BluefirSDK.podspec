#
#  Be sure to run `pod spec lint BluefirSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.license      = { :type => 'LGPL', :text => <<-LICENSE
                        ® 2016 Bluefir All Rights Reserved.
                        LICENSE
                   }
  ...
  s.author             = { "ForrestLuo" => "forrestluo@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/forrestluo/BluefirSDK.git", :tag => "#{s.version}" }
  ...
  s.vendored_libraries = "Ads/joyingAds/libJYMobSDK.a", "Ads/libChanceAd/libChanceAd.a"
